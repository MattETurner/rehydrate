...
use rmsync_publish::{DraftPost, GhostClient, PublishError, Publisher, WordpressClient};
...
fn ghost_publish_draft_sends_jwt_and_html_body() {
    ...
    let client = GhostClient::new(rmsync_publish::GhostCredentials {
        base_url: addr.clone(),
...
fn wordpress_publish_sends_basic_auth_and_html_content() {
    ...
    let client = WordpressClient::new(rmsync_publish::WordpressCredentials {
        base_url: addr.clone(),
        username: "alice".into(),
